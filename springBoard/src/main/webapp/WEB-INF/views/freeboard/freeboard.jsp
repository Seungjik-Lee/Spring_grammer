	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="/freeboard"> <i class="fas fa-fw fa-table"></i> <span>Freeboard</span></a>
			</li>
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							...
							<div style="float: right">
								...
								<a class="m-0 font-weight-bold btn btn-primary"
									href="/freeboard/insertform">글쓰기</a>
							</div>
						</div>
						<div class="card-body" style="clear: both">
							<div class="table-responsive">
								<form id="frm" action="/freeboard/delete" method="post">
									<table class="table table-bordered" id="freeboardTable"
										...
										<tbody>
											<c:forEach items="${list}" var="index">
												<tr style="cursor: pointer;" class="ttr"
													value="${index.idx}">
													<td class='ftd'><input style="width: 100%;"
														type="checkbox" name="cks" class="ckcls"
														value="${index.idx}" /></td>
													<td>${index.idx}</td>
													<td>${index.title}</td>
													<td>${index.name}</td>
